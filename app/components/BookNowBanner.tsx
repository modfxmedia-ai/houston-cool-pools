      ...
      {show && (
        ...
        >
          <div className="pointer-events-none mx-auto max-w-5xl">
            <div className="pointer-events-auto relative overflow-hidden rounded-2xl border border-white/10 bg-[var(--color-navy-deep)]/95 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.6)] backdrop-blur-xl">
              {/* Ambient glows */}
              <span
                aria-hidden
              ...
              <div className="relative flex items-center gap-3 px-4 py-3 sm:gap-5 sm:px-6 sm:py-4">
                ...
                <div className="relative hidden shrink-0 sm:block">
                  <motion.span
                    ...
                    className="absolute inset-0 rounded-2xl bg-[var(--color-pool)]/60"
                  />
                  <span className="relative grid h-12 w-12 place-items-center rounded-2xl bg-gradient-to-br from-[var(--color-pool)] to-[var(--color-pool-deep)] text-white shadow-md">
                ...
                <div className="flex shrink-0 items-center gap-2">
                  <a
                    ...
                    className="hidden items-center gap-2 rounded-full border border-white/20 px-4 py-2.5 text-[11px] font-bold uppercase tracking-[0.16em] text-white transition hover:border-[var(--color-gold-light)] hover:text-[var(--color-gold-light)] md:inline-flex"
                  >
                  ...
                  <Link
                    href={bookHref}
                    className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-[var(--color-pool)] to-[var(--color-pool-deep)] px-4 py-2.5 text-[11px] font-bold uppercase tracking-[0.16em] text-white shadow-[0_10px_28px_-8px_rgba(0,124,182,0.7)] transition-all hover:-translate-y-0.5 hover:shadow-[0_14px_36px_-8px_rgba(79,195,224,0.85)] sm:px-5"
                  >
