...
export const POOL_TYPES: PoolTypeCategory[] = [
  {
    ...
    photos: [
      ...
      { src: "/images/gallery/hd/merlin-1.jpg", alt: "Rectangular pool with raised spa and fire trough" },
      { src: "/images/gallery/hd/puranik-1.jpg", alt: "Rectangular reflecting pool by the lake" },
    ],
  },
  {
    id: "freeform",
    ...
    photos: [
      { src: "/images/gallery/hd/clark-estate.jpg", alt: "Free-form pool with rock waterfall" },
      { src: "/images/gallery/hd/stidham.jpg", alt: "Kidney-shaped pool with round spa and fire bowls" },
      { src: "/images/gallery/hd/family-4.jpg", alt: "Custom free-form backyard pool" },
      { src: "/images/gallery/hd/family-5.jpg", alt: "Free-form pool with raised spa and fire bowls" },
