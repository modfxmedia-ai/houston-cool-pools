...
export const POOL_PRICING_TIERS: PoolPricingTier[] = [
  {
    ...
    images: [
      { src: "/images/pricing-65k-90k/01.jpg", alt: "Custom gunite pool with spacious patio" },
      { src: "/images/pricing-65k-90k/02.jpg", alt: "Backyard pool with travertine decking" },
      { src: "/images/pricing-65k-90k/03.jpg", alt: "Freeform pool with natural stone accents" },
      { src: "/images/pricing-65k-90k/04.jpg", alt: "Modern pool with clean waterline tile" },
      { src: "/images/pricing-65k-90k/05.jpg", alt: "Backyard oasis with lush landscaping" },
      { src: "/images/pricing-65k-90k/06.jpg", alt: "Sparkling blue pool ready for summer" },
      { src: "/images/pricing-65k-90k/07.jpg", alt: "Pool and spa combination with stone coping" },
      { src: "/images/pricing-65k-90k/08.jpg", alt: "Resort-style pool with tanning ledge" },
      { src: "/images/pricing-65k-90k/09.jpg", alt: "Custom pool with elevated spa and spillway" },
      { src: "/images/pricing-65k-90k/10.jpg", alt: "Pool with decorative tile and water features" },
      { src: "/images/pricing-65k-90k/11.jpg", alt: "Evening pool view with landscape lighting" },
    ],
  },
  {
